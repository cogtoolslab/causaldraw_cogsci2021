 ...
 *
 * Hijacked: preload screen displays message and increase preload time to 3min ('max_load_time' = 180000)
 * 
 * 
 **/
window.jsPsych = (function() {
  ...
  core.init = function(options) {
    ...
    var defaults = {
      ...
      'message_preload_bar': 'Loading... this may take a few minutes!',
  ...
  core.loadFail = function(message){
    message = message || '<p>Game failed to load. Please refresh your page.</p>';
    loadfail = true;
